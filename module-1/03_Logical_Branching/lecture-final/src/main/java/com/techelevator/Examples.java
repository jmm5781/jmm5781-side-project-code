...
//
//		boolean isTen = mynum == 10;
//		System.out.println("Number is 10: " + isTen);

		if (mynum == 10) {
			// call method
			System.out.println("In block");
			System.out.println("Yes Number is 10!!!!");
		} else {
			System.out.println("Nope not 10.");
		}
...
//		}
		...
		if (bigNum > 50) {
			System.out.println("Greater than 50");
			if (bigNum > 70) {
				System.out.println("Is also greate than 70");
			}
		}
