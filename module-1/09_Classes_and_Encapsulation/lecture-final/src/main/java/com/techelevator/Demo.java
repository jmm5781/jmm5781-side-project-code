...
//        TechElevatorStudent.sayMyName();
        student1.sayMyName();
            ...
            /*
        System.out.println("##############################################################################");
        System.out.println("        Class [static] variables (like welcomeMessageText) have ONE value ");
        ...
        // Changing above changes message for ALL instances
        System.out.println(student1.getWelcomeMessage());
        System.out.println(student2.getWelcomeMessage());

        /*
        System.out.println("##############################################################################");
        System.out.println("     Class [static] methods (like getStatusDescriptionFromStatusCode) do not require  ");
        System.out.println("     an instance and are called using the class as well");
        System.out.println("##############################################################################");
        System.out.println();
