...
public class TechElevatorStudent {
    ...
    private static String[] STATUS_DESCRIPTIONS = { INTERESTED_DESC, NOT_INTERESTED_DESC,  NEEDS_INTERVIEW_DESC, WAITING_FOR_LONG_A_T_DESC,
     ...
     */
    private String name;
    private String studentId; // This should be final
    private Integer age;
