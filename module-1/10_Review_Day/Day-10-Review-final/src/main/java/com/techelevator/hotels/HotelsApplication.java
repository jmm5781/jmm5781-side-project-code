...
public class HotelsApplication {
    ...
    private Map<Integer, Reservation> quickReservationLookup = new HashMap<>();
    ...
    public HotelsApplication() {
        ...
        quickReservationLookup = loader.loadQuickLookUp(hotels);
            ...
            if (selectedHotel != null) {
                ...
                if (choice.equalsIgnoreCase("v")) {
                    ...
                    if (newReservation != null) {
                        ...
                        selectedHotel.getReservations().add(newReservation);

                        // TODO
                        // add it to the quick lookup map too
                        quickReservationLookup.put(newReservation.getId(), newReservation);
    ...
    public void handleQuickLookup() {
        ...
        if (resId != null) {
            ...
            Reservation reservation = quickReservationLookup.get(resId);
            if (reservation != null) {
...
//
//        System.out.println(Reservation.getNextId());
//        System.out.println(Reservation.getNextId());
